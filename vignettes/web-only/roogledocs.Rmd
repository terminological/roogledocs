...
knitr support). 
* A fairly complex development would be support for Google slides, although a
very simple tagged text and image substitution equivalent might be simple, in
reality for this you are likely to want to do more complex operations.
